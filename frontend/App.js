...
import NewPostCameraScreen from './src/pages/NewPost/NewPostCameraScreen'
...
//       >
//         {/* Home */}
//         <Tab.Screen name="Home" component={Register} options={{ headerShown: false, title: 'Home' }} />
...
function TabNavigator() {
  return (
    ...
    >
      ...
      <Tab.Screen name="Search" component={Search} options={{ headerShown: false, title: 'Search' }} />
      <Tab.Screen name="NewPost" component={CreateNewPost} options={{ headerShown: false}} />
      <Tab.Screen name="Profile" component={Profile} options={{ headerShown: false, title: 'Profile' }} />
      <Tab.Screen name="Settings" component={Settings} options={{ headerShown: false, title: 'Settings' }} />
    </Tab.Navigator>
  );
      ...
      <NavigationContainer>
        <SafeAreaView className='bg-white flex-1 '>
          <Stack.Navigator initialRouteName='Register'>
            ...
            <Stack.Screen name='NewPostCameraScreen' component={NewPostCameraScreen} options={{ headerShown: false }} />
